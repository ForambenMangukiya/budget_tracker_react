...
import { Grid, Button, Alert, Container, Typography, Box, Input } from "@mui/material";
...
const handleFileInputChange = (event) => {
    ...
    <Grid item xs={12}>
        ...
        <form onSubmit={onSubmit}>
            <Box>
                <label htmlFor="image">
                <Button component="span" variant="outlined" sx={{ mt: 4,
            ...
            <Box style={{ display: "flex", justifyContent: "space-around", paddingBottom: "20px"}}>
                ...
                <Button variant="outlined" onClick={handleClose} sx={{ mt: 8,
                transition: 'all 0.3s ease',
                '&:hover': { transform: 'scale(1.1)' },}}>
            ...
            {error && (
            <Alert severity="error" sx={{ typography: 'body1', fontSize: '1.5rem' }}>>
            ...
            <Alert sx={{ typography: 'body1', fontSize: '1.5rem'}}>
             {successMessage}
              ...
              <Typography sx={{ textAlign: "left", fontSize: '12px', mt: 3 }}>{trans.tran_description}</Typography>  
              <Typography sx={{ textAlign: "left", fontSize: '12px', }}>{trans.tran_amount}</Typography>  
              <Typography sx={{ textAlign: "left", fontSize: '12px', }}>{trans.tran_date}</Typography>  
            </Alert>
            )}
        </form> 
        </Box>
